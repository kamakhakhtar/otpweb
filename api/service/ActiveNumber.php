  ...
  if($left == "00:00"){
    if ($row['active_status'] == 2) {
        ...
        if ($row['sms_text'] == "") {
            ...
            $add_balance = $user_data['balance'];
            $cut_otp = $user_data['total_otp'] - 1;
    
            // Uncomment the following lines if you want to execute the updates
            ...
            // Uncomment the following line if you want to execute the update
