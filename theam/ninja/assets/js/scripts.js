...
! function(p, x) {
    ...
    p.ClassBody = function() {
        ...
        p.BreakClass("." + l, d.lg, {
            ...
            p.BreakClass("." + l, d.lg), p.BreakClass("." + i, d.lg)
        })
    }, p.Prettify = function() {
        ...
        var e = e || ".nk-menu-toggle",
            ...
            a = t ? u(n, t) : n;
        x(e).on("click", function(e) {
            (p.Win.width < d.lg || x(this).parents().hasClass(i)) && p.Toggle.dropMenu(x(this), a), e.preventDefault()
        })
    }, p.TGL.showmenu = function(e, t) {
        var n = x(e || ".nk-nav-toggle"),
            a = x("[data-content]"),
            i = a.hasClass(l) ? d.lg : d.xl,
            e = {
        ...
        x(e).exists() && x(e).each(function() {
            var e = x(this).data("auto-responsive"),
                ...
                t = t ? " with-export" : "",
                i = '<"row justify-between g-2' + t + '"<"col-7 col-sm-4 text-start"f><"col-5 col-sm-8 text-start"<"datatable-filter"<"d-flex justify-content-end g-2"' + a + 'l>>>><"datatable-wrap my-3"t><"row align-items-center"<"col-7 col-sm-12 col-md-9"p><"col-5 col-sm-12 col-md-3 text-start text-md-end"i>>',
                t = '<"row justify-between g-2' + t + '"<"col-7 col-sm-4 text-start"f><"col-5 col-sm-8 text-start"<"datatable-filter"<"d-flex justify-content-end g-2"' + a + 'l>>>><"my-3"t><"row align-items-center"<"col-7 col-sm-12 col-md-9"p><"col-5 col-sm-12 col-md-3 text-start text-md-end"i>>',
                a = {
                    responsive: !0,
                    autoWidth: !1,
