<div class="nk-footer">
    <div class="container wide-xl">
        ...
        <div class="nk-footer-copyright"> &copy; 2023 OTPNinja Template by <a href="https://softnio.com" target="_blank">BlckHrt</a></div>
        <div class="nk-footer-links">
            <ul class="nav nav-sm">
                ...
                <li class="nav-item"><a href="<?php echo $site_data['support_url'];?>" class="nav-link"><em class="icon ni ni-send"></em><span class="ms-1">Join Telegram</span></a></li>
            </ul>
        </div>
        </div>
